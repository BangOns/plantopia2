...
export default function CTA() {
  ...
  const img1 = useTransform(scrollYProgress, [0, 0.5], [500, 0]);

  return (
    <div
      ref={targetRef}
      className="mt-20 pb-14 md:mt-32 md:pb-20 lg:mt-[251px] lg:pb-[110px] mx-[12.5px] md:mx-[35px] lg:mx-[71px] m-auto"
    >
      {/* Dekstop */}
